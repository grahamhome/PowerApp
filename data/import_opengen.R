...
get_csvdata_opengen <- function(){
  ...
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen_pmu_vang.csv")
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen_pmu_vmag.csv")
}


#Change up the names so that they all match
clean_names_opengen<- function(){
...
get_merged_data_opengen<- function(){
...
import_data <- function(){
  get_csvdata_opengen()
  clean_names_opengen()
  get_merged_data_opengen()
  get_map_data_opengen()
  get_rocdata_opengen()
}
