...
get_csvdata_icestorm2 <- function(){
  ...
  Freq <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_ice_storm2_pmu_freq.csv")
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_ice_storm2_pmu_vang.csv")
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_ice_storm2_pmu_vmag.csv")
}


#Change up the names so that they all match
clean_names_icestorm2  <- function(){
...
get_merged_data_icestorm2  <- function(){
...
get_map_data_icestorm2  <- function(){
...
get_rocdata_icestorm2 <- function(){
  Dv <<- as.matrix(Volt[,-1])
  Cv <<- Volt[1,]
  currt_voltdiff <<- 1
...
import_data <- function(){
  get_csvdata_icestorm2()
  clean_names_icestorm2()
  get_merged_data_icestorm2()
  get_map_data_icestorm2()
  get_rocdata_icestorm2()
}
