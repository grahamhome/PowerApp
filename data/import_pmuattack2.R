...
get_csvdata_pmuattack2 <- function(){
  ...
  Freq <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen2_pmu_freq.csv")
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen2_pmu_vang_error.csv")
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen2_pmu_vmag_error.csv")
}


#Change up the names so that they all match
clean_names_pmuattack2<- function(){
...
get_merged_data_pmuattack2<- function(){
...
get_map_data_pmuattack2  <- function(){
...
import_data <- function(){
  get_csvdata_pmuattack2()
  clean_names_pmuattack2()
  get_merged_data_pmuattack2()
  get_map_data_pmuattack2()
}
