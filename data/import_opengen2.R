...
get_csvdata_opengen2 <- function(){
  ...
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen2_pmu_vang.csv")
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_gen2_pmu_vmag.csv")
}


#Change up the names so that they all match
clean_names_opengen2<- function(){
...
get_merged_data_opengen2<- function(){
...
get_map_data_opengen2  <- function(){
...
import_data <- function(){
  get_csvdata_opengen2()
  clean_names_opengen2()
  get_merged_data_opengen2()
  get_map_data_opengen2()
}
