...
get_csvdata_quake2 <- function(){
  ...
  Freq <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_quake2_pmu_freq.csv")
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_quake2_pmu_vang.csv",stringsAsFactors = FALSE)
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_quake2_pmu_vmag.csv",stringsAsFactors = FALSE)
  pmus <<- pmus[!(pmus$Latitude < 40),]
}


#Change up the names so that they all match
clean_names_quake2 <- function(){
...
get_merged_data_quake2 <- function(){
...
import_data <- function(){
  get_csvdata_quake2()
  clean_names_quake2()
  get_merged_data_quake2()
  get_map_data_quake2()
}

#Name of the data set
name <- function(){
  n <- "WECC BPA Earthquake 2"
  n
}
