...
get_csvdata_tenn <- function(dpath){
...
get_covvariance_data_tenn  <- function(){
...
import_data <- function(){
  ...
  get_csvdata_tenn("data/")
  clean_names_tenn()
  get_merged_data_tenn()
  get_covvariance_data_tenn()
  get_map_data_tenn()
}

#Returns a list of the plots that this data can be used to create
use_plots <- function(){
  list('linear.R','map.R','heatmap.R','correlation.R','bar.R','dendrogram.R')
}
