...
get_csvdata_pmumalfunction2 <- function(){
...
clean_names_pmumalfunction2  <- function(){
...
get_merged_data_pmumalfunction2 <- function(){
...
get_map_data_pmumalfunction2  <- function(){
...
import_data <- function(){
  get_csvdata_pmumalfunction2()
  clean_names_pmumalfunction2()
  get_merged_data_pmumalfunction2()
  get_map_data_pmumalfunction2()
}
