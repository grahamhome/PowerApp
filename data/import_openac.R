...
get_csvdata_openac <- function(){
  ...
  Freq <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_ac_line_pmu_freq.csv")
  Pangle <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_ac_line_pmu_vang.csv")
  Volt <<- read.csv("data/rawdata/BPA_230kV_data/weccbpaabove230_open_ac_line_pmu_vmag.csv")
}


#Change up the names so that they all match
clean_names_openac  <- function(){
...
get_merged_data_openac  <- function(){
